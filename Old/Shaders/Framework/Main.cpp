...
bool LoadContent()
{
	...
	test.model.AddBuffer(positions, BUFFER_INDEXES::POSITION_BUFFER);
	...
	test.model.AddBuffer(tex_coords, BUFFER_INDEXES::TEXTURE_COORDS_0);
	return true;
}
...
bool Render()
{
	...
	glm::mat4 M = test.TransformMatrix();
